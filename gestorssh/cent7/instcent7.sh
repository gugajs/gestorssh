...
wget https://github.com/gugajs/gestorssh/raw/ntech/gestorssh/cent7/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf > /dev/null 2>&1
...
wget https://github.com/gugajs/gestorssh/raw/ntech/gestorssh/gestorssh.zip > /dev/null 2>&1
...
createdb(){
wget https://github.com/gugajs/gestorssh/raw/ntech/gestorssh/bdgestorssh.sql > /dev/null 2>&1
...
cd /bin || exit
wget https://github.com/gugajs/gestorssh/raw/ntech/gestorssh/userteste.sh
wget https://github.com/gugajs/gestorssh/raw/ntech/gestorssh/autobackup.sh
